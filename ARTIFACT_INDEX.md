...
_Generated from front-matter across the repo. Last build: `2026-08-09T22:10:09.589Z` · commit `dda593e` · `39` artifacts._
...
| [System Architecture — Aheed Online Store](specs/architecture.md) | doc | 1.7.0 | 2026-08-09 | approved | internal | The technical source of truth for infrastructure and Clean Architecture layering — Cloudflare Workers + Neon + S3-compatible storage, vendor-agnostic and multi-tenant (vendor-scoped) by design. |
