...
_Generated from front-matter across the repo. Last build: `2026-08-10T00:09:11.643Z` · commit `39b8413` · `41` artifacts._
...
| [Tech Stack](specs/tech-stack.md) | doc | 1.1.0 | 2026-08-10 | approved | internal | Technical guardrails for the Aheed Online Store — application, data, auth, storage, payments, email, hosting, caching, compliance, and testing choices, with the ADRs that govern where they differ from the original proposal. |
