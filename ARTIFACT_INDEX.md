...
_Generated from front-matter across the repo. Last build: `2026-08-09T20:35:21.892Z` · commit `85acdc7` · `38` artifacts._
...
| [Roadmap](specs/roadmap.md) | doc | 1.8.0 | 2026-08-09 | approved | internal | Master backlog and phase sequencing (M0, P0-P8, plus inserted P2.5) for the Aheed Online Store, plus the running change log of roadmap revisions and phase closures. |
