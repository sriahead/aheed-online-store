...
_Generated from front-matter across the repo. Last build: `2026-08-08T16:51:39.993Z` · commit `508c0c9` · `35` artifacts._
...
| [System Architecture — Aheed Online Store](specs/architecture.md) | doc | 1.3.0 | 2026-08-08 | approved | internal | The technical source of truth for infrastructure and Clean Architecture layering — Cloudflare Workers + Neon + S3-compatible storage, vendor-agnostic and multi-tenant (vendor-scoped) by design. |
