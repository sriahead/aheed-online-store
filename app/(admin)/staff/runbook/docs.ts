...
- Earn 1 Aheed Loyalty Point for every £1 spent.
  ...
  },
  {
    ...
    category: "Checkout & Orders",
    summary:
      "How payments are processed securely via Stripe without storing sensitive card details.",
    lastUpdated: "2026-08-01",
    content: `
...
- Only tokenized payment IDs are referenced to verify transaction completion.
  ...
  },
  {
    ...
    summary:
      "Aheed self-delivers with local drivers across Leicester. Learn what each status stage means.",
    lastUpdated: "2026-08-01",
    content: `
