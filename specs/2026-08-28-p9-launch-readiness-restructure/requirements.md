...
R1. GitHub milestones exist with these exact titles: `P9 — Production launch readiness`,
    `P9.1 — Security & transaction safety`, `P9.2 — Production infrastructure & reliability`,
    `P9.3 — Launch quality validation`, `P9.4 — Launch certification`, and
    `P10 — Post-launch improvements`.

R2. The milestones `P8.6 — Storefront discovery & conversion` and
    `P8.7 — Fulfilment & merchandising data models` are **closed** and hold **zero open issues**.

R3. The milestone `P8 — Deployment & launch` holds **zero open issues**. It remains open as a
...
R4. #340 is open on milestone `P9.1 — Security & transaction safety`.

R5. Each of #113, #104, #227, #246, #175, #219, #101, #94 and #236 is open on milestone
    `P9.2 — Production infrastructure & reliability`.

R6. Each of #174, #350, #351 and #398 is open on milestone `P9.3 — Launch quality validation`.
...
R8. Every issue that was open on `P8.6 — Storefront discovery & conversion` or
    `P8.7 — Fulfilment & merchandising data models` before this slice — #394, #395, #396, #399,
...
R12. Seven issues exist on `P9.1 — Security & transaction safety`, one for each of: guest order PII
...
R13. Five issues exist on `P9.2 — Production infrastructure & reliability`, one for each of:
...
R14. Four issues exist on `P9.3 — Launch quality validation`, one for each of: storefront LCP
...
R15. Three issues exist on `P9.4 — Launch certification`, one for each of: production game day;
