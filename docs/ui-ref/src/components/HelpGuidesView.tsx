    ...
    <div className="max-w-7xl mx-auto px-4 py-8 font-['Poppins',sans-serif]">
      ...
      <div className="bg-gradient-to-r from-[#1B5E20] to-emerald-800 text-white rounded-3xl p-8 mb-8 shadow-lg">
        <div className="max-w-2xl">
          ...
          <p className="text-emerald-100 text-sm mb-6 leading-relaxed">
            Task-oriented guides written in plain English. Learn about guest orders, Stripe payment privacy, Aheed Leicester self-delivery, and earning loyalty rewards.
          </p>
      ...
      <div className="mt-12 bg-emerald-50 rounded-3xl p-8 border border-emerald-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-5 rounded-2xl border border-emerald-100 shadow-2xs">
            <h3 className="font-bold text-slate-900 text-sm mb-2 text-[#1B5E20]">Leicester Postcode Coverage</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
              We deliver locally across Leicester postcodes LE1, LE2, LE3, LE4, LE5, and Oadby/Wigston. Delivery fee is £2.99 or FREE over £35.
            </p>
          </div>
        </div>
      </div>
