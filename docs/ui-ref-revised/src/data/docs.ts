...
- Save multiple Milton Keynes delivery addresses.
...
- Only tokenized payment IDs are referenced to verify transaction completion.
  ...
  },
  {
    ...
    summary: 'Aheed self-delivers with local drivers across Milton Keynes. Learn what each status stage means.',
    lastUpdated: '2026-08-01',
    content: `
# Understanding Delivery Status

Aheed Food Centre operates its own fleet of local delivery drivers in Milton Keynes (postcodes MK1 to MK14).
...
2. **Out for Delivery**: Your items are loaded onto our dedicated refrigerated delivery van and dispatched to your Milton Keynes address.
...
Our way of thanking our loyal Milton Keynes community!
