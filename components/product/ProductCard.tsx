...
export function ProductCard({
  ...
  return (
    <Link
      ...
      className="group relative bg-white rounded-2xl border border-black/10 hover:border-action/50 hover:shadow-xl transition-all duration-300 flex flex-col overflow-hidden cursor-pointer h-full"
    >
      {/* Top badges */}
