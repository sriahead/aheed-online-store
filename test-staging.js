...
(async () => {
  ...
  await page.goto('https://staging.aheedfoodcentre.nocaped.com/products/halal-lamb-mince', { waitUntil: 'networkidle2' });
  ...
  const btn = await page.waitForSelector('button:has-text("Add to cart"), button:has-text("Out of stock")');
