...
describe("composePublicUrl", () => {
  it("joins base + key with one slash", () => {
    expect(composePublicUrl("https://cdn.example.com", "products/sku-1/main.webp"))
      .toBe("https://cdn.example.com/products/sku-1/main.webp");
  });
  it("tolerates trailing/leading slashes", () => {
    expect(composePublicUrl("https://cdn.example.com/", "/a/b.png"))
